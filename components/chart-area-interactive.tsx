...
const monthlyData = financialData.reduce((acc, transaction) => {
  const month = transaction.date.substring(0, 7) // YYYY-MM format
  if (!acc[month]) {
    acc[month] = { revenue: 0, expenses: 0, date: month }
  }
